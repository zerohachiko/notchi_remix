...
## 🚨 Important for 1.0.0 users

If you're currently on Notchi 1.0.0, please install 1.0.1 manually from the DMG below.

The in-app updater in 1.0.0 is broken for that first upgrade, but should work thereafter through the new automatic update system.
