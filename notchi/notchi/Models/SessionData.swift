...
private let logger = Logger(subsystem: "com.zerohachiko.notchi-remix", category: "SessionData")
...
final class SessionData: Identifiable {
    ...
    init(sessionId: String, cwd: String, sessionNumber: Int, isInteractive: Bool = true, agentSource: AgentSource = .claude, existingXPositions: [CGFloat] = []) {
        self.id = sessionId
        self.cwd = cwd
